...
###### START DEFINE INPUTS HERE ######

#input data source
dataSource = 'C:/Users/marsmith/Desktop/tile/data/ny/str900_all.lyr'

#location for output cache
outputPath = 'C:/Users/marsmith/Desktop/tile/cache'

#input tiling scheme
tilingScheme = 'C:/Users/marsmith/Desktop/tile/PredefinedTilingScheme_levels_ALL.xml'

#set start and end scales
startScale = 14
endScale = 15

###### END DEFINE INPUTS HERE ######
...
def createCache(dataSource,outputPath,tilingScheme):
	...
	scaleList = webMapScaleList [startScale:endScale]

	#use datasource filename as cacheName
	cacheName = os.path.splitext(os.path.basename(dataSource))[0]

	#final output path includes '_alllayers'
	fullCachePath = outputPath + '/' + cacheName + "/_alllayers/"

	#kill output folder tree if it exists
...
if __name__ == "__main__":
	...
	cachePath = createCache(dataSource,outputPath,tilingScheme)     
	print "       ...Done..."
